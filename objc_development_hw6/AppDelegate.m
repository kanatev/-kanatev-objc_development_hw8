...
//    PeopleTableView *vc = [[PeopleTableView alloc] init];
    AnimationVC *vc = [[AnimationVC alloc] init];


//    UINavigationController *nav = [[UINavigationController alloc] initWithRootViewController:vc];
//    nav.navigationBar.topItem.title = @"Business Contacts";
...
//важно переопределить этот метод, иначе пуши не будут работать
